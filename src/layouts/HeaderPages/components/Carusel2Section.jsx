...
import Alivali from "../../../assets/Images/Alivali.png"
...
const chefs = [
    ...
    { id: 2, name: "Alivali", role: "Oshpaz", img: Alivali, bio: "Yevropa taomlari bo'yicha mutaxassis." },
        ...
        <div className="w-full max-w-7xl mx-auto py-10 px-4">
            <div className="text-center mb-16">
                <h2 className="text-4xl md:text-5xl font-bold  mb-4">
                    <span className="text-[#FF8A00]">Faxriy</span> azolarimiz
                </h2>
                <p className="text-gray-600 max-w-2xl mx-auto text-xl md:text-xl leading-relaxed">
                    Har bir faxriy a'zo bizning jamiyatimizning qadriyatlari, tarixi va an'analari bilan bog'langan holda, o'z tajribasi va bilimlari bilan sizlarga ulashadilar. </p>
            </div>
            <Swiper
